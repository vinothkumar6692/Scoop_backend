...
public class The_Verge_Apps_Software {

	public static void main(String[] args) throws Exception {
		// TODO Auto-generated method stub
		// TODO Auto-generated method stub
		final Connection conn = DBConnection.createConnection();
		URL url = new URL("http://www.theverge.com/apps/rss/index.xml");
		...
		for (int temp = 0; temp < nList.getLength(); temp++) {
			...
			if (nNode.getNodeType() == Node.ELEMENT_NODE) {
				...
				preparedStatement = conn.prepareStatement("insert into the_verge_apps_software values(?,?,?)");
