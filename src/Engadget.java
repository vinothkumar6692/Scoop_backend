...
public class Engadget {

	public static void main(String[] args) throws Exception {
		// TODO Auto-generated method stub
		final Connection conn = DBConnection.createConnection();
		URL url = new URL("http://www.theverge.com/rss/group/features/index.xml");
		...
		for (int temp = 0; temp < nList.getLength(); temp++) {
			...
			if (nNode.getNodeType() == Node.ELEMENT_NODE) {
				...
				preparedStatement = conn.prepareStatement("insert into engadget_feed values(?,?,?)");
